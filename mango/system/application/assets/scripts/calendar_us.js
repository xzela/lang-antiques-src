...
var A_TCALDEF = {
	...
	'imgpath' : '/prototype/images/' // directory with calendar images
}
...
function tcal (a_cfg, a_tpl) {
	...
	if (!this.e_icon) {
		document.write('<img src="' + a_tpl.imgpath + 'icons/calendar.png" id="' + this.s_iconId + '" onclick="A_TCALS[\'' + this.s_id + '\'].f_toggle()" class="tcalIcon" alt="Open Calendar" />');
		this.e_icon = f_getElement(this.s_iconId);
	}
...
function f_tcalShow (d_date) {
	...
	this.e_icon.src = this.a_tpl.imgpath + 'icons/calendar_delete.png';
...
function f_tcalHide (n_date) {
	if (n_date) {
		...
		//callback code here
		if(this.a_cfg.callback) {
			this.a_cfg.callback(this.e_input.value);
		}
	}
	...
	// change icon and status
	this.e_icon = f_getElement(this.s_iconId);
	this.e_icon.src = this.a_tpl.imgpath + 'icons/calendar.png';

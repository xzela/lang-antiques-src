...
Ajax.InPlaceCollectionEditor.prototype.__initialize = Ajax.InPlaceCollectionEditor.prototype.initialize;
Ajax.InPlaceCollectionEditor.prototype.__getText = Ajax.InPlaceCollectionEditor.prototype.getText;
Ajax.InPlaceCollectionEditor.prototype.__onComplete = Ajax.InPlaceCollectionEditor.prototype.onComplete;
Ajax.InPlaceCollectionEditor.prototype = Object.extend(Ajax.InPlaceCollectionEditor.prototype, {
    ...
    setOptions: function(options){
        this.options = Object.extend(Object.extend(this.options,{
            emptyText: 'click to select option...',
            emptyClassName: 'inplaceeditor-empty'
        }),options||{});
    },

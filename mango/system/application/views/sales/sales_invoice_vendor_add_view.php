...
<head>
	...
	<title><?php echo $this->config->item('project_name'); ?> - Invoices - Create Vendor Invoice</title>
		...
		$(document).ready(function() {
			$("#vendor_input")
				...
				.result(function(e, item) {
					document.location = base_url + 'sales/create_invoice/vendor/add/' + item.vendor_id;
				});
		});
...
?>
	<div id="content">
		<h2>Invoices - Create Vendor Invoice</h2>
		<ul id='submenu'>
		...
		<?php echo form_open('sales/create_invoice_vendor_add') ?>

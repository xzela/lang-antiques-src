...
?>
	<div id="content">
		<h2>
			Invoices - Add Shipping Method to Invoice #<?php echo $invoice_data['invoice_id']; ?> for:
		...
		<h3>What kind of Shipping are we using?</h3>
		<?php echo form_open('sales/add_shipping_method/' . $invoice_data['invoice_id']); ?>
		...
		<table class='form_table'>
			<tr>
				<td class='title'>Ship Method:</td>
				<td>
					<input type='text' name='ship_method' class='input_field' value='<?php echo set_value('ship_method', $invoice_data['ship_method']); ?>' />
				</td>
			</tr>
			<tr>
				<td class='title'>Ship Cost:</td>
				<td>
					$<input type='text' name='ship_cost' class='input_field' value='<?php echo set_value('ship_cost', $invoice_data['ship_cost']); ?>' />
				</td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
				<td></td>
				<td><input type='submit' value='Update Ship Method' /></td>
			</tr>
		</table>
		<?php echo form_close(); ?>

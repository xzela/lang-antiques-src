	...
	<div id="content">
		...
		<table>
			<?php foreach($group as $major):?>
				...
				?>
				<tr>
					<td class='heading' colspan='10'><?php echo $major['major_data']['mjr_class_name']; ?></td>		
				</tr>
				<tr>
				...
				<?php foreach($major['items'] as $item):?>
					<?php if($item['invoice_item_status'] == 0): //0=sold?>
						<?php
							$total_count++;
			...
			<?php foreach($layaway_data as $data):?>
				<?php
					$grand_total_count++;
					$grand_total_cost += $data['purchase_price'];
					$grand_total_price += $data['sale_price'];
				?>
				<tr>			
			...
			<?php endforeach;?>
				...
				<tr>
					<td colspan='6' class='sum left_side title'>Grand Total Retail:</td>

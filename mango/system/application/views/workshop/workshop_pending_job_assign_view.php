...
?>
	<div id="content">
		...
		<ul id="submenu">
			<li><?php echo anchor('workshop/pending_job_edit/' . $job_data['pending_job_id'], 'Back to Pending Repair Details'); ?></li>
			<li>|</li>
		</ul>
		<?php $attributes = array('method' => 'post', 'name' => 'add_job_form');?>
		<?php echo form_open('workshop/pending_job_assign/' . $job_data['pending_job_id'], $attributes) ?>
		<table class='form_table'>
			...
			<tr>
				...
				<td>
					<input name="est_return_date" type="text" value="<?php echo set_value('est_return_date', $job_data['est_return_date']); ?>"/>
					<script type="text/javascript">
					A_TCALDEF.imgpath = '<?php echo $this->config->item('js_image_path'); ?>';
					new tcal ({
						// form name
			...
			<tr>
				...
				<td colspan='3'><input name="est_price" type="text" value="<?php echo set_value('est_price', $job_data['est_price']); ?>" /> </td>
			</tr>
			<tr>
				<td class="title">Instructions:</td>
				<td colspan="3">
					<textarea name="instructions" cols="50" rows="4"><?php echo set_value('instructions', $job_data['instructions']); ?></textarea>
				</td>
			</tr>
			<tr>
				<td class="title">Notes:</td>
				<td colspan="3">
					<textarea name="notes" cols="50" rows="3"><?php echo set_value('notes', $job_data['notes']); ?></textarea>
				</td>
			</tr>
			<tr>

...
?>
	<div id="content">
		<h2>Delete an Inventory Item</h2>
		<ul id='submenu'>
			<li><?php echo anchor('admin', snappy_image('icons/resultset_previous.png', '', 'pagination_image') . ' ' . 'Back to Admin Options'); ?></li>

		</ul>
		<div class='error'>
			<h3 class='warning'>Warning: Deleting an item is serious procedure. Delete at ones own risk!</h3>
		...
		<?php echo form_open('admin/delete_item'); ?>
			<div class='div_form'>
				<label for='item_number'>Item Number:</label>
				<input name="item_number" type="text" size='25'/>
				<input class='button' name="delete_item" type="submit" value="Delete Item" />
				<br />

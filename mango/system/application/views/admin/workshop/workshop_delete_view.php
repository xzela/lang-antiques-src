...
?>
	<div id="content">
		...
		<?php echo form_open('admin/workshop_delete'); ?>
			<div class='div_form'>
				<label for='workshop_id'>Workshop ID:</label>
				<input name="workshop_id" type="text" size='25'/>
				<input class='button' name="delete_workshop" type="submit" value="Delete Workshop" />
				<br />

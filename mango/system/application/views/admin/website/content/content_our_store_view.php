...
<head>
	...
	<title><?php echo $this->config->item('project_name'); ?> - Admin Options - Edit Our Store Content</title>
...
?>
	<div id="content">
		<h2 class='item'>Admin - Edit Our Store Content</h2>
		<ul id='submenu'>
		...
		<?php echo form_open('admin/content_our_store'); ?>

...
<head>
	...
	<title><?php echo $this->config->item('project_name'); ?> - Admin Options - Edit Our Staff Content</title>
...
?>
	<div id="content">
		<h2 class='item'>Admin - Edit Our Staff Content</h2>
		<ul id='submenu'>
			<li><?php echo anchor('admin', snappy_image('icons/resultset_previous.png', '', 'pagination_image') . ' ' . 'Back to Admin'); ?></li>
			<li>|</li>
		</ul>
		<p>
			Edit the Our Staff Content
		</p>
		<?php echo form_open('admin/content_our_staff'); ?>

...
?>
	<div id="content">
		...
		<ul id='submenu'>
			<li><?php echo anchor('admin/modifier_edit/' . $modifier_data['modifier_id'], snappy_image('icons/resultset_previous.png', '', 'pagination_image') . 'Back to Modifier'); ?></li>
			<li>|</li>			
		</ul>
		<p>Here is a list of all the known Items with this Modifiers.</p>

...
<head>
	...
	<title><?php echo $this->config->item('project_name'); ?> - Admin Options - Reactivate User</title>
...
?>
	<div id="content">
		<h2>User Options - Reactivate User</h2>
		<ul id='submenu'>
			<li><?php echo anchor('admin', snappy_image('icons/resultset_previous.png', '', 'pagination_image') . ' ' . 'Back to Admin Options'); ?></li>
		</ul>
		<p>Here is a list of all the known users in Clangity, select the Reactivate link to bring'em back.</p>
		...
		<?php foreach($users as $user): ?>
			<div class="user_row" id="user_<?php echo $user['user_id']; ?>">
				...
				<div class="user_option">
					<a class="green" href="javascript:reactivateUser(<?php echo $user['user_id']; ?>)">Reactivate User</a>
				</div>
			</div>
		<?php endforeach; ?>
